...
export function AddFriendModal({setMode}:{setMode:Dispatch<SetStateAction<boolean>>}){
    ...
    return <div className="absolute w-full h-full bg-black bg-opacity-70 flex items-center justify-center">
        <div className="absolute bg-neutral-900 border-2 border-emerald-100 w-1/2 h-1/4 rounded-2xl flex flex-col items-center p-4 gap-4 overflow-hidden">
            ...
            <h1 className="text-2xl font-semibold self-center">Add Friend</h1>
